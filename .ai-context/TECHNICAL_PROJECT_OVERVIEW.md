...
## Goal
Publish the Obsidian-based “Polska” vault as a Quartz 4 site hosted through GitHub Pages. Quartz handles nav/link generation automatically, so keeping notes up to date just means committing Markdown files.
