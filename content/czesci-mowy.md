...
- **duży dom** (big house) - великий дім
- **mała kobieta** (small woman) - маленька жінка
- **czerwone jabłko** (red apple) - червоне яблуко
...
- **być** (to be) - бути
- **mieć** (to have) - мати
- **robić** (to do/make) - робити
- **mówić** (to speak) - говорити
- **czytać** (to read) - читати
- **pisać** (to write) - писати
...
- **szybko** (quickly/fast) - швидко
- **wolno** (slowly) - повільно
- **dobrze** (well) - добре
- **źle** (badly) - погано
- **bardzo** (very) - дуже
- **tutaj** (here) - тут
...
- **pod** (under) - під
- **nad** (above/over) - над
- **przed** (before/in front of) - перед
- **za** (behind/for) - за
- **o** (about) - про
- **bez** (without) - без
...
- Jestem **w** domu (I'm at home) - Я вдома
...
- **że** (that) - що
- **jeśli** (if) - якщо
- **ponieważ** (because) - тому що
- **więc** (so/therefore) - отже
...
**Główne (Cardinal numbers) - кількісні:**

- **jeden/jedna/jedno** (one) - один/одна/одно
- **dwa/dwie** (two) - два/дві
- **trzy** (three) - три
- **cztery** (four) - чотири
- **pięć** (five) - п'ять
- **dziesięć** (ten) - десять
...
**Porządkowe (Ordinal numbers) - порядкові:**

- **pierwszy/pierwsza/pierwsze** (first) - перший
...
- **Hej!** (Hey!) - Гей!
- **Wow!** (Wow!) - Вау!
- **Niestety** (Unfortunately/Alas) - На жаль
- **Brawo!** (Bravo!) - Браво!
- **Ojej!** (Oh dear!) - Ойой!
...
- **czytający** (reading) - читаючий
- **pisany** (written) - написаний
...
3. **Відмінювання дієслів:** Звертайте увагу на закінчення дієслів для різних осіб.
4. **Прийменники з відмінками:** Різні прийменники вимагають різних відмінків.